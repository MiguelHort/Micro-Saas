...
//     const API_KEY = "AIzaSyDo6c4NpG74bRfwULWAA3KwpaF9khArR2U";
...
//         const prompt = "Escreva uma frase do Albert"
...
//                 <section className='flex justify-center items-center w-full'>
//                     <div className='flex flex-col justify-center items-center w-4/5'>
//                         <div className='flex flex-col justify-center items-center gap-8 bg-white p-10 rounded-lg mt-10'>
//                             <div className='flex flex-col gap-2'>
//                                 <label>Qual o titulo do post?</label>
//                                 <input className='w-[600px] h-10 pl-5 text-sm rounded-lg solid border-pink-600 border-2 outline-none' type="text" placeholder='Assunto do Post' />
//                                 <button type="submit" ></button>
//                             </div>
//                             <div className='flex flex-col'>
//                                 <div className='flex items-center pl-5 h-10 bg-pink-600 rounded-t-lg'>
//                                     <p className='text-white font-bold'>AI-Generated Legend</p>
//                                 </div>
//                                 <div className='w-[600px] h-auto rounded-b-lg solid p-5 border-pink-600 border-2 outline-none' >
//                                     <p></p>
...
//                                 </div>
//                                 <div className='w-[600px] h-auto rounded-b-lg solid p-5 border-pink-600 border-2 outline-none' >
//                                     <p>#beyoncé #álbum #novaiorque #dezembro</p>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
